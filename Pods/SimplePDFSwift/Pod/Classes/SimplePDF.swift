...
open class SimplePDF {
    ...
    open class DefaultTextFormatter {
        ...
        open func attributedStringForStyle(_ string: String, style: TextStyle) -> NSAttributedString {
            ...
            case .h2:
                ...
                paragraphStyle.alignment = .left
            case .h3:
                attrString.addAttribute(NSFontAttributeName, value:UIFont.boldSystemFont(ofSize: 11), range: NSMakeRange(0, attrString.length))
                paragraphStyle.alignment = .left
            case .h4:
            ...
            case .h6:
                attrString.addAttribute(NSFontAttributeName, value:UIFont.boldSystemFont(ofSize: 20), range: NSMakeRange(0, attrString.length))
            case .bodyText:
                attrString.addAttribute(NSFontAttributeName, value:UIFont.systemFont(ofSize: 18), range: NSMakeRange(0, attrString.length))
    ...
    fileprivate class PDFWriter {
        ...
        fileprivate func addPageHeaderFooter() {
            ...
            // draw top line
            drawLine(CGPoint(x: availablePageRect.origin.x, y: availablePageRect.origin.y + 0),
                p2: CGPoint(x: availablePageRect.origin.x + availablePageRect.size.width, y: availablePageRect.origin.y + 0))
            // draw bottom line
    ...
    public init(pdfTitle: String, authorName: String, fileName : String = "PRINT TEMPLATE.pdf", replaceFileIfExisting: Bool = true, pageSize: PageSize = .a4, pageOrientation: PageOrientation = .portrait,
