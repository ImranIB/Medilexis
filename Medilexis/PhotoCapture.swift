...
//  Medilexis
//
//  Created by iOS Developer on 16/01/2018.
...
class PhotoCapture: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIDocumentInteractionControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PhotoDictationold.imageTapped(gesture:)))
