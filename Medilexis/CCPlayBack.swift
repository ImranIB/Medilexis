...
//  Medilexis
//
//  Created by iOS Developer on 07/04/2017.
...
class CCPlayBack: UIViewController, AVAudioPlayerDelegate, UITextViewDelegate, UITabBarDelegate, UIDocumentInteractionControllerDelegate {
            ...
            if count > 0 {
                ...
                for item in fetchResult {
                    ...
                    if item.recordingURL != "N/A" {
                        ...
                        fileURL = documentsDirectoryURL.appendingPathComponent(item.recordingName! + ".m4a")
    ...
    @objc func doneClicked(){
        ...
        if recordedTransciption.text != cctext{
    ...
    func fetchTranscription(){
        ...
        do {
            ...
            for item in fetchResult {
                ...
                self.cctext = item.transcription
    ...
    @IBAction func dismissCCPlayBack(_ sender: UIBarButtonItem) {
