...
class HXDIctation: UIViewController, AVAudioRecorderDelegate, AVAudioPlayerDelegate, UITextViewDelegate, UIDocumentInteractionControllerDelegate   {
    ...
    @IBAction func transcribe(_ sender: UIButton) {
        ...
        if currentReachabilityStatus == .reachableViaWiFi ||  currentReachabilityStatus == .reachableViaWWAN {
            ...
            hxActivityIndicator.isHidden = false
            hxActivityIndicator.startAnimating()
