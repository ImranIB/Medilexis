...
class AnotherPhotoPlayback: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIDocumentInteractionControllerDelegate {
    ...
    @IBAction func save(_ sender: UIButton) {
        ...
        if fileAnotherPhotoDictationPlayback == "" {
            ...
            actionController.addAction(Action(ActionData(title: "Next", image: UIImage(named: "saveNext")!), style: .default, handler: { action in
                ...
                if self.fileAnotherPhotoDictationPlayback == "false" {
