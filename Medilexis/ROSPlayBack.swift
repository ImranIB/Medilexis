...
class ROSPlayBack: UIViewController, AVAudioPlayerDelegate, UITextViewDelegate, UITabBarDelegate, UIDocumentInteractionControllerDelegate {
            ...
            if count > 0 {
                ...
                for item in fetchResult {
                    ...
                    if item.recordingURL != "N/A" {
                        ...
                        ROSfileURL = documentsDirectoryURL.appendingPathComponent(item.recordingName! + ".m4a")
                        
                        do {
                            audioPlayer = try AVAudioPlayer(contentsOf: ROSfileURL)
    ...
    @objc func doneClicked(){
        ...
        if recordedTransciption.text != rostext {
        ...
        if currentReachabilityStatus == .reachableViaWiFi ||  currentReachabilityStatus == .reachableViaWWAN {
            ...
            SFSpeechRecognizer.requestAuthorization { authStatus in
                if authStatus == SFSpeechRecognizerAuthorizationStatus.authorized {
                    ...
                    let request = SFSpeechURLRecognitionRequest(url: self.ROSfileURL)
        ...
        do {
            ...
            for item in fetchResult {
                ...
                recordedTransciption.text = item.transcription
                 self.rostext = item.transcription
