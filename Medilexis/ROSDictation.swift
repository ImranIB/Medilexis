...
class ROSDictation: UIViewController, AVAudioRecorderDelegate, AVAudioPlayerDelegate , UITextViewDelegate, UIDocumentInteractionControllerDelegate  {
    ...
    @IBAction func recordPauseBtn(_ sender: UIButton) {
        ...
        let status = defaults.value(forKey: "ROSRecording") as! String
